...
const resultStylish = fs.readFileSync(path.resolve(process.cwd(), '_fixtures__/result_stylish.txt'), 'utf-8');
const resultPlain = fs.readFileSync(path.resolve(process.cwd(), '__fixtures__/result_plain.txt'), 'utf-8');
